...
import AnimatedSection, { StaggerContainer, StaggerItem, MagneticHover } from '@/components/AnimatedSection'
  ...
  return (
    <section ref={heroRef} className="relative h-screen-safe w-full overflow-hidden">
      ...
      <motion.div className="absolute inset-0 z-0" style={{ y: heroY, scale: heroScale }}>
        <Image 
          src="/images/hero-alghero-beach.jpg" 
          alt="Alghero beach" 
          fill 
          priority 
      ...
      {/* Ambient vignette */}
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, transparent 0%, rgba(0,0,0,0.3) 100%)' }} />

      <motion.div 
        className="relative z-10 h-full flex flex-col justify-end pb-24 px-6 md:px-12 lg:px-20 max-w-7xl"
      ...
      >
        ...
        >
          <TextScramble text="ALGHERO · SARDEGNA · SUITE ESCLUSIVE" delay={300} duration={800} scrambleOnView={true} className="font-sans text-[11px] text-white/60 tracking-[0.4em] uppercase" />
        </motion.span>
        ...
        <h1 className="font-serif italic font-light text-white leading-[0.85] mb-6">
          <div className="overflow-hidden">
            <motion.span 
              ...
              className="block text-[52px] sm:text-7xl md:text-[120px]"
            >
              La Suite
            </motion.span>
          </div>
          <div className="overflow-hidden">
            <motion.span 
              ...
              className="block text-[52px] sm:text-7xl md:text-[120px] ml-2 sm:ml-4 md:ml-20"
            >
              N4
            </motion.span>
          </div>
        ...
        >
          ...
          <MagneticHover strength={0.25}>
            <Link href="/rooms" className="border border-white/30 text-white px-10 py-5 text-sm font-sans uppercase tracking-[0.2em] hover:bg-white hover:text-navy transition-all duration-500">
...
function EditorialSection() {
  const { lang } = useLanguage()
  return (
    <section className="bg-ivory py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center max-w-7xl mx-auto">
        <div className="relative group">
          <ImageReveal
            src="/images/rooms/suite-luxury-tripla/room-01.jpeg"
          ...
          <motion.div 
            ...
            className="absolute -bottom-8 -right-8 w-2/3 aspect-square bg-sand p-12 hidden md:block"
          >
        ...
        <div className="space-y-12">
          <div>
            ...
            <SplitText as="h2" className="font-serif text-5xl md:text-6xl text-navy leading-tight italic" type="words" delay={0.2} duration={0.8}>
              {lang === 'it' ? 'Il Lusso della Semplicità' : 'The Luxury of Simplicity'}
            </SplitText>
          </div>
          <AnimatedSection type="fadeUp" delay={0.3}>
          ...
          <AnimatedSection type="fadeUp" delay={0.4}>
            <Link href="/gallery" className="inline-block font-sans text-xs uppercase tracking-[0.3em] text-navy border-b border-gold pb-2 hover:border-navy transition-all duration-500 group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mb-10 max-w-2xl">
              <SplitText
                as="h2"
                className="font-serif italic text-[42px] md:text-[58px] text-navy leading-[1.1]"
                type="words"
                delay={0.1}
                duration={0.8}
              >
            ...
            <motion.p 
              ...
              className="font-sans font-light text-[16px] text-muted leading-[1.9] mb-16 max-w-xl"
            >
              {lang === 'it'
            ...
            <StaggerContainer staggerDelay={0.12} delay={0.3} className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <StaggerItem>
                <div>
                  <span className="font-serif text-navy text-[48px] leading-tight block">
                    <AnimatedCounter target={4} duration={2000} />
                  </span>
                  <span className="text-muted font-sans text-[11px] uppercase tracking-[0.3em] mt-2 block">Suite</span>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div>
                  <span className="font-serif text-navy text-[48px] leading-tight block">
                    <AnimatedCounter target={4} duration={2200} delay={100} />
                  </span>
                  <span className="text-muted font-sans text-[11px] uppercase tracking-[0.3em] mt-2 block">{lang === 'it' ? 'Terrazze' : 'Terraces'}</span>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div>
                  <span className="font-serif text-navy text-[48px] leading-tight block">★</span>
                  <span className="text-muted font-sans text-[11px] uppercase tracking-[0.3em] mt-2 block">{lang === 'it' ? 'Esclusivo' : 'Exclusive'}</span>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div>
                  <span className="text-navy text-[32px] block">🌊</span>
                  <span className="text-muted font-sans text-[11px] uppercase tracking-[0.3em] mt-[1.4rem] block">{lang === 'it' ? 'Vista Mare' : 'Sea View'}</span>
                </div>
              </StaggerItem>
            </StaggerContainer>
          </div>
          ...
          <div className="lg:col-span-5 relative mt-12 lg:mt-0">
            ...
            <motion.div 
              ...
              className="absolute -bottom-16 -left-12 md:-left-20 w-3/4 aspect-[4/3] overflow-hidden z-20 hidden md:block border-[12px] border-ivory"
            >
              <Image src="/images/balcony/balcony-01.jpeg" alt="Sea view terrace" fill className="object-cover" sizes="400px" />
            </motion.div>
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-gold/5 -z-0 animate-pulse-glow" />
          </div>
        </div>
      </div>
    </section>
...
function MarqueeStrip() {
  ...
  return (
    <div className="bg-navy h-[70px] flex items-center overflow-hidden relative">
      <div className="flex animate-marquee whitespace-nowrap">
        {[...Array(4)].map((_, i) => (
          <span key={i} className="font-serif italic text-[28px] text-gold/80 px-2">{text}</span>
        ))}
      </div>
    </div>
  )
...
function SuiteCard({ room, index, t, lang }: { room: (typeof property.rooms)[0]; index: number; t: (v: { it: string; en: string }) => string; lang: string }) {
  return (
    ...
    >
      <TiltCard tiltAmount={6} glareOpacity={0.1} scale={1.01}>
        <Link href={`/rooms/${room.slug}`} className="group bg-white flex flex-col relative shrink-0 border border-border hover:border-gold/50 transition-colors duration-500" style={{ width: '100%', minWidth: 280, maxWidth: 380, height: 520 }}>
          <div className="h-[65%] w-full overflow-hidden">
            <Image 
              src={room.hero} 
              alt={t(room.name)} 
              fill 
              className="object-cover !relative w-full h-full grayscale-[20%] group-hover:scale-105 group-hover:grayscale-0 transition-all duration-700" 
              sizes="380px" 
            />
          </div>
      ...
      <div className="hidden md:flex h-screen">
        <div className="w-1/3 p-24 flex flex-col justify-center shrink-0 z-10 bg-navy">
          <motion.span 
            ...
            className="text-gold font-sans tracking-[0.4em] uppercase text-xs mb-6 block font-medium"
          >
  ...
  return (
    <section className="bg-[#F0EDE8] py-32 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        {/* Left: Image */}
        <ImageReveal
          src="/images/sea-star-restaurant.jpg"
          alt="Sea Star Beach Restaurant"
        ...
        >
          ...
          <div className="aspect-[4/5] overflow-hidden">
            <Image 
              ...
              alt="Sea Star Beach Restaurant" 
              fill
              className="object-cover !relative w-full h-full transition-transform duration-1000 group-hover:scale-105" 
              sizes="50vw" 
            />
          </div>
        ...
        >
          ...
          <SplitText as="h2" className="font-serif italic text-5xl md:text-6xl text-navy leading-tight mb-8" type="words" delay={0.2} duration={0.7}>
            Sea Star Beach Restaurant
          </SplitText>
          <div className="w-12 h-px bg-gold mb-10" />
          <p className="font-sans text-lg text-navy/80 leading-relaxed mb-10 max-w-md">
            {lang === 'it'
          ...
          <div className="bg-gold/5 p-8 mb-12 w-full max-w-md flex items-center space-x-4">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/sea_star_alghero" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-gold text-sm font-sans hover:opacity-70 transition-opacity">
              <Instagram size={16} /> @sea_star_alghero
            </a>
            <a href="https://www.instagram.com/sea_star_alghero" target="_blank" rel="noopener noreferrer"
...
// ─── BOOKING with SPOTLIGHT & PARTICLES ───
function BookingSection() {
  const { lang } = useLanguage()
  return (
    <MouseSpotlight 
      className="relative min-h-screen flex items-center justify-center py-24 px-6 overflow-hidden bg-navy" 
      size={500} 
      color="oklch(58% 0.12 42 / 0.12)" 
      opacity={0.12}
    >
      <AmbientParticles 
        count={30} 
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/images/balcony/balcony-02.jpeg" alt="Aerial Alghero" fill className="object-cover opacity-30" sizes="100vw" />
        <div className="absolute inset-0 bg-gradient-to-b from-navy/60 via-navy/80 to-navy" />
      </div>
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center">
        <AnimatedSection type="fadeUp" delay={0.1}>
          <span className="font-sans text-white/60 uppercase tracking-[0.4em] text-xs mb-6 block">
        ...
        <div className="mb-4">
          <SplitText
            as="h2"
            className="font-serif italic text-5xl md:text-[72px] text-white leading-tight"
            type="words"
            delay={0.2}
            duration={0.8}
          >
        ...
        <motion.div 
          ...
          className="w-full max-w-[600px] bg-white p-10 md:p-14 relative overflow-hidden group"
        >
          {/* Subtle border glow on hover */}
          <div className="absolute inset-0 border border-transparent group-hover:border-gold/20 transition-colors duration-700 pointer-events-none" />
          <div className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="flex flex-col text-left">
                <label className="font-sans text-[10px] uppercase tracking-[0.3em] text-navy/50 mb-2">Check-in</label>
                <input type="date" className="w-full bg-transparent border-0 border-b border-border py-2 focus:ring-0 focus:border-gold transition-colors duration-300 font-sans text-navy outline-none" />
              </div>
              <div className="flex flex-col text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="flex flex-col text-left">
                ...
                <select className="w-full bg-transparent border-0 border-b border-border py-2 focus:ring-0 focus:border-gold transition-colors duration-300 font-sans text-navy appearance-none cursor-pointer outline-none">
            ...
            <MagneticHover strength={0.15}>
              <Link href="/availability"
                className="block w-full bg-gold text-white py-6 font-sans uppercase tracking-[0.3em] text-sm hover:bg-navy transition-all duration-700 text-center group mt-4 relative overflow-hidden shimmer-btn"
              >
          ...
          <div className="mt-12 pt-10 border-t border-border">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-6">
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-[#635BFF] text-white text-[11px] sm:text-[13px] font-sans font-medium rounded-none">
              ...
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-black text-white text-[11px] sm:text-[13px] font-sans font-medium rounded-none">
              ...
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-border text-[#3c4043] text-[11px] sm:text-[13px] font-sans font-medium rounded-none">
                <svg width="14" height="14" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
                G Pay
              </span>
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-border text-[#3c4043] text-[11px] sm:text-[13px] font-sans font-medium rounded-none">
        ...
        <p className="mt-12 font-sans text-white/40 text-sm font-light">
          ...
          <a href="https://wa.me/393478327243" target="_blank" rel="noopener noreferrer"
            className="text-white underline underline-offset-8 decoration-gold/50 hover:decoration-gold transition-all duration-500"
          >
