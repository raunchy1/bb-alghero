        ...
        <div className="w-full max-w-[600px] bg-white p-10 md:p-14 shadow-[0_40px_60px_-15px_rgba(27,28,26,0.04)]">
          ...
          <div className="mt-12 pt-10 border-t border-[#e4e2de]/50">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-6">
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-[#635BFF] text-white text-[11px] sm:text-[13px] font-sans font-medium rounded-md">
              ...
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-black text-white text-[11px] sm:text-[13px] font-sans font-medium rounded-md">
              ...
              <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-[#dadce0] text-[#3c4043] text-[11px] sm:text-[13px] font-sans font-medium rounded-md">
