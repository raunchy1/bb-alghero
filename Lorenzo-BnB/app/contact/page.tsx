  ...
  return (
    <main className="bg-ivory min-h-screen">
      ...
      <section className="px-6 md:px-12 pb-16 md:pb-24">
        <div className="max-w-[1624px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-2xl md:text-3xl text-navy hover:text-[#094730] transition-colors duration-300 tracking-tight"
                >
                  {contact.phone}
                </a>
              </div>
              ...
              <div>
                ...
                <p className="text-2xl md:text-3xl text-navy tracking-tight">
              ...
              <div>
                ...
                <p className="text-base text-navy font-mono tracking-wide">
                  {contact.cin}
                </p>
              </div>
            ...
            {/* Right — Map */}
            <div>
              <div className="relative w-full aspect-square lg:aspect-[4/5] rounded-none overflow-hidden">
                <iframe
                  title="Google Maps"
      ...
      <section className="px-6 md:px-12 pb-16 md:pb-24">
        <div className="max-w-[1624px] mx-auto">
          <div
            className="p-6 md:p-8 rounded-none"
            style={{
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-navy">
            ...
            <div className="space-y-3 mb-4">
              <div>
                ...
                <p className="text-lg md:text-xl font-mono text-navy tracking-wide">IT71A0306984893100000009177</p>
              </div>
              <div>
      ...
      <section className="px-6 md:px-12 pb-28 md:pb-44">
        <div className="max-w-[1624px] mx-auto">
          <div
            className="p-6 md:p-8 rounded-none text-center max-w-lg mx-auto"
            style={{
          ...
          >
            ...
            <p
              className="text-navy"
              style={{ fontFamily: 'var(--font-cormorant), Cormorant, serif', fontStyle: 'italic', fontSize: 20 }}
            >
              {lang === 'it'
